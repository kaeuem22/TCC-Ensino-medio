const lista_Materiais = [
    ...
    {
        imagem: "https://www.filipeflop.com/wp-content/uploads/2017/07/A.jpg",
        nome: "Célula de carga",
        description: "Usado para medir o peso ou a força aplicada a partir da deformação de seu corpo",
        preco:"R$ 14, 90",
        link:"https://www.google.com/search?q=celula+de+carga+50kg&source=lmns&tbm=shop&bih=635&biw=1366&hl=pt-BR&sa=X&ved=2ahUKEwjo7a_UgJb7AhX3BLkGHeUIBt4Q_AUoAXoECAEQAQ"
    },
    {
        imagem: "https://io.convertiez.com.br/m/abana/shop/products/images/202/medium/comedouro-para-caes-medios-17-l_375.jpg",
        nome: "Pote de ração p/ cães",
        description: "Um pote de comida para cachorros, com formato circular",
        preco:"R$ 20,00",
        link:"https://www.google.com/search?q=pote+de+comida+para+cachorro&source=lmns&tbm=shop&bih=635&biw=1366&hl=pt-BR&sa=X&ved=2ahUKEwiQ6Ij4g5b7AhVSN7kGHVYvB_oQ_AUoAXoECAEQAQ"
    },
    {
        imagem: "https://www.baudaeletronica.com.br/media/catalog/product/cache/1/image/800x/9df78eab33525d08d6e5fb8d27136e95/2/6/2627_6.png",
        nome: "Módulo HX711",
        description: "Módulo usado para converter os sinais enviados pela célula de carga. Tornado possível que o arduino os reconheça",
        preco:"R$ R$ 17, 12",
        link:"https://www.google.com/search?q=m%C3%B3dulo+hx711&source=lmns&tbm=shop&bih=635&biw=1366&hl=pt-BR&sa=X&ved=2ahUKEwjuiO3vhZb7AhUEMrkGHXzyBBAQ_AUoAXoECAEQAQ"
    },
]